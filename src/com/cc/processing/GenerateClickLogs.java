 ...
 * Description : logs(click_time, user_id, res_id, res_type, url) 废了
 */

public class GenerateClickLogs {
	public static void main(String[] args) {
		try {
			...
			System.out.println("Connect to database logs successfully!");
			
			// 获取集合
			MongoCollection<Document> collectionLogs = mongoDatabase.getCollection("logs");
